<!-- code source : https://codepen.io/eroxburgh/pen/zYYyEPg (thanks a lot Ethan @eroxburgh) -->
...
<body>
    ...
    <div class="error">
        ...
        <div class="error__buttons">
            <a type="button" href="/login" class="error__button error__button--active">LOGIN</a>
            <a type="button" href="/home" class="error__button">HOME</a>
        </div>
    </div>
