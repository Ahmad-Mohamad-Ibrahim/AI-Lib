...
<body class="h-full bg-primary-shade-200">
    <!-- MARK:Nav
    -->
    <!--
        ...
        <nav class="bg-secondary text-white">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link href="/contacts" type="a" active="{{ request()->is('contacts') }}">Contacts
                                </x-nav-link>
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    <x-mob-nav-link href="/contacts" active="{{ request()->is('contacts') }}">Contacts</x-mob-nav-link>
